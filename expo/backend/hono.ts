...
import {
  membersCountOptions,
  handleMembersCountRequest,
} from './api/ivx-members-count';
import {
...
import { ownerAuthProxyOptions, handleIVXOwnerAuthDiagnostic, handleIVXOwnerAuthLogin, handleIVXOwnerAuthRefresh, handleIVXOwnerAuthRecover, handleIVXOwnerAuthRepair, handleIVXOwnerAuthExchangeRecovery, handleIVXOwnerAuthUpdatePassword } from './api/ivx-owner-auth-proxy';
...
app.get('/health', (context) => {
  ...
  return context.json({
    ...
    routes: [
      ...
      // Owner auth proxy (registered at lines 3562-3575)
      'GET /api/ivx/owner-auth/diagnostic',
      ...
      // Members count (registered at lines 3766-3768)
      'GET /api/ivx/members/count',
      'HEAD /api/ivx/members/count',
      // Member registration (registered at lines 3747-3763)
      ...
      // IVX auth (registered at lines 3870+)
      'POST /api/ivx/auth/register',
      'POST /api/ivx/auth/verify-email',
      'POST /api/ivx/auth/verify-sms',
      // Proof test
      'GET /api/proof-test',
      'GET /api/ivx/owner-ai/chat-durability-proof',
      'GET /api/ivx/project-dashboard',
      // Autonomy/sync
...
app.options('/api/ivx/owner-auth/exchange-recovery', () => ownerAuthProxyOptions());
app.options('/api/ivx/owner-auth/update-password', () => ownerAuthProxyOptions());
...
app.post('/api/ivx/owner-auth/exchange-recovery', async (c) => handleIVXOwnerAuthExchangeRecovery(c.req.raw));
app.post('/api/ivx/owner-auth/update-password', async (c) => handleIVXOwnerAuthUpdatePassword(c.req.raw));
...
// ---- IVX Members Count (public, read-only aggregate counts) ----
app.options('/api/ivx/members/count', () => membersCountOptions());
app.get('/api/ivx/members/count', async (c) => handleMembersCountRequest(c.req.raw));
app.head('/api/ivx/members/count', async (c) => handleMembersCountRequest(c.req.raw));
