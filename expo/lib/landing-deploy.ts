/**
 * landing-deploy.ts — S3 deployment logic for the landing page.
 *
 * NOTE: This file is in lib/ because it's imported by app screens (admin/landing-page.tsx).
 * The deploy/ directory contains shell scripts for CI/CD.
 * This file handles in-app deployment via AWS SigV4 signing.
 */
