...
import { lenders as mockLenders } from '@/constants/lenders';
import type { DiscoveredLender } from '@/constants/lender-discovery';
...
export const [LenderProvider, useLenders] = createContextHook(() => {
  ...
  const lenderKeys = useMemo(() => [['imported-lenders']], []);
  useRealtimeTable('imported_lenders', lenderKeys);
