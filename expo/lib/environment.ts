...
const developmentConfig: EnvironmentConfig = {
  name: 'development',
  apiBaseUrl: process.env.EXPO_PUBLIC_API_BASE_URL || process.env.EXPO_PUBLIC_RORK_API_BASE_URL || 'http://localhost:3000',
...
const stagingConfig: EnvironmentConfig = {
  name: 'staging',
  apiBaseUrl: process.env.EXPO_PUBLIC_STAGING_API_URL || process.env.EXPO_PUBLIC_RORK_API_BASE_URL || 'https://staging.ivxholding.com',
  enableDebugLogging: true,
...
const productionConfig: EnvironmentConfig = {
  name: 'production',
  apiBaseUrl: process.env.EXPO_PUBLIC_PRODUCTION_API_URL || process.env.EXPO_PUBLIC_RORK_API_BASE_URL || 'https://ivxholding.com',
