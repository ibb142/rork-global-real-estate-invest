/**
 * Auto-bundled migration SQL for Phase 1 owner persistence.
 * Source: expo/deploy/supabase/ivx-platform-persistence-phase1.sql
 * Keep in sync if the .sql file is edited.
 */
export const PLATFORM_PERSISTENCE_PHASE1_SQL = `-- =============================================================================
