...
function mapSupabaseRowToCamelCase(row: any): any {
  ...
  return {
    ...
    salePrice: row.salePrice ?? row.sale_price ?? 0,
...
const VALID_COLUMNS = new Set([
  ...
  'total_investment', 'expected_roi', 'estimated_value', 'appraised_value', 'sale_price',
  ...
  'trust_info', 'trustInfo', 'property_value', 'propertyValue', 'salePrice',
