      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.headerRow}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.subtitle}>Verifies IVX-owned AI proxy is live and the Rork toolkit client-direct path is off.</Text>
          </View>
        </View>
          ...
          <>
            ...
            {runtime ? (
              <View style={styles.card}>
                ...
                <Row
                  label="Legacy Rork toolkit key in backend env"
