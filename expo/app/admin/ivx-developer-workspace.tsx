...
type TabId = 'files' | 'assistant' | 'patches' | 'tests';
...
export default function IVXDeveloperWorkspaceScreen() {
  ...
  }, [seniorApprovedActionSummary, seniorFilesAffected, seniorGoal, seniorProposedPlan, seniorRiskLevel, seniorRollbackOption, seniorRunLoading]);
              ...
              <View style={styles.ownerApprovalCard}>
                ...
                <View style={styles.patchActions}>
                  ...
                  <Pressable
                    ...
                    style={[styles.smallBtn, styles.dangerBtn, (!seniorGoal.trim() || !seniorProposedPlan.trim() || seniorFilesAffected.length === 0 || !seniorRollbackOption.trim() || seniorRunLoading) ? styles.buttonDisabled : null]}
                    disabled={!seniorGoal.trim() || !seniorProposedPlan.trim() || seniorFilesAffected.length === 0 || !seniorRollbackOption.trim() || seniorAuditLoading || seniorRunLoading}
