...
import { fetchVideoFeed, downloadFeedVideo, type FeedVideo } from '@/lib/video-feed';
import {
  toggleProjectLike,
  trackProjectShare,
  ...
  return (
    <View style={styles.container}>
      ...
      {feedQuery.isLoading ? (
        ...
        <View style={styles.centerFill}>
          <Text style={styles.centerText}>Could not load the video feed.</Text>
        ...
        <View style={styles.centerFill}>
          <Text style={styles.centerTitle}>No videos yet</Text>
          <Text style={styles.centerText}>New project videos will appear here.</Text>
        </View>
      ) : (
        <FlatList
          data={videos}
      ...
      <View pointerEvents="none" style={[styles.headerTitleWrap, { top: insets.top + 12 }]}>
        <Text style={styles.headerTitle}>IVX Videos</Text>
      </View>
