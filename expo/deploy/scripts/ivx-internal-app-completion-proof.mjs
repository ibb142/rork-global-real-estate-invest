...
const FILE_PROBES = [
  ...
  { label: 'backend IVX AI wrapper', file: 'backend/ivx-ai-runtime.ts', patterns: ['requestIVXAIText', "const DEFAULT_IVX_AI_MODEL = readTrimmed(process.env.IVX_AI_MODEL) || 'openai/gpt-4o';", "provider: 'chatgpt'", "runtime: 'vercel_ai_gateway'", "architecture: 'ivx-ai'"] },
