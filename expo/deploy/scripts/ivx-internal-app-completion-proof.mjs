...
const FILE_PROBES = [
  ...
  { label: 'Owner AI request service', file: 'expo/src/modules/ivx-owner-ai/services/ivxAIRequestService.ts', patterns: ["const DEFAULT_IVX_OWNER_AI_MODEL = 'openai/gpt-4o-mini';", 'requestLocalAppBrain', 'requestLocalAIProvider', 'ivxOwnerMemoryService.handleLocalCommand', 'getLastIVXOwnerAIRuntimeProof'] },
  ...
  { label: 'backend IVX AI wrapper', file: 'backend/ivx-ai-runtime.ts', patterns: ['requestIVXAIText', "const DEFAULT_IVX_AI_MODEL = 'openai/gpt-4o-mini';", "provider: 'chatgpt'", "runtime: 'vercel_ai_gateway'", "architecture: 'ivx-ai'"] },
  { label: 'public chat AI path', file: 'backend/public-chat-ai.ts', patterns: ['generatePublicChatAnswer', 'requestIVXAIText', "module: 'public-chat'", "source: 'chatgpt'", "const DEFAULT_PUBLIC_CHAT_MODEL = 'openai/gpt-4o-mini';"] },
