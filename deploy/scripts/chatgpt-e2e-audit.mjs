...
const EXPECTED_CHATGPT_MODEL = process.env.IVX_OWNER_AI_MODEL || process.env.PUBLIC_CHAT_MODEL || process.env.OPENAI_MODEL || 'openai/gpt-4o-mini';
const EXPECTED_GATEWAY_BASE_PATH = '/v3/ai';

const FILE_PROBES = [
  { label: 'backend IVX AI runtime wrapper', file: 'backend/ivx-ai-runtime.ts', patterns: ['createGateway', 'generateText', "const GATEWAY_BASE_PATH = '/v3/ai';", "const DEFAULT_IVX_AI_MODEL = 'openai/gpt-4o-mini';", 'process.env.EXPO_PUBLIC_IVX_AI_GATEWAY_URL', 'process.env.AI_GATEWAY_API_KEY', 'requestIVXAIText', "provider: 'chatgpt'", "runtime: 'vercel_ai_gateway'"] },
  { label: 'backend public chat ChatGPT service', file: 'backend/public-chat-ai.ts', patterns: ["const DEFAULT_PUBLIC_CHAT_MODEL = 'openai/gpt-4o-mini';", 'requestIVXAIText', "module: 'public-chat'", "source: 'chatgpt'", 'generatePublicChatAnswer', "source: 'fallback'"] },
  { label: 'backend owner AI route', file: 'backend/api/ivx-owner-ai.ts', patterns: ["const DEFAULT_OWNER_AI_MODEL = 'openai/gpt-4o-mini';", 'requestIVXAIText', "module: 'owner-room'", "provider: 'chatgpt'", "source: 'remote_api'", 'endpoint: aiResult.endpoint'] },
  ...
  { label: 'P0 assistant route', file: 'backend/api/assistant.ts', patterns: ["const DEFAULT_MODEL = 'openai/gpt-4o-mini';", 'requestIVXAIText', "module: 'p0-ai-assistant'", "provider: 'chatgpt'", "source: 'remote_api'"] },
  { label: 'P1 plan creator route', file: 'backend/api/plan-creator.ts', patterns: ["const DEFAULT_MODEL = 'openai/gpt-4o-mini';", 'requestIVXAIText', "module: 'p1-plan-creator'", "provider: 'chatgpt'", "source: 'remote_api'"] },
  ...
  { label: 'owner AI frontend request service', file: 'expo/src/modules/ivx-owner-ai/services/ivxAIRequestService.ts', patterns: ["const DEFAULT_IVX_OWNER_AI_MODEL = 'openai/gpt-4o-mini';", 'EXPO_PUBLIC_IVX_AI_GATEWAY_URL', 'fetchOwnerAIEndpointWithFallback', "source: 'remote_api'", 'getIVXAIIndependenceSnapshot'] },
