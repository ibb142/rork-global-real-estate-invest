package com.rork.ivxholdings.util

object AppConfig {
    const val API_BASE_URL = "https://api.ivxholding.com"
    const val OWNER_PASSWORDLESS_LOGIN_PATH = "/api/ivx/owner-passwordless-login"
    const val OWNER_AI_REQUEST_PATH = "/api/ivx/owner-ai/request"
    const val VERCEL_EXIT_DASHBOARD_PATH = "/api/ivx/vercel-exit/dashboard"
    const val VERCEL_EXIT_AGENTS_PATH = "/api/ivx/vercel-exit/agents"
    const val VERCEL_EXIT_INVENTORY_PATH = "/api/ivx/vercel-exit/inventory"
