...
function buildOwnerAISystemPrompt(input: {
  ...
  return [
    ...
    'TRUTH-FIRST — VERIFICATION LABELS (hard rule): use these labels precisely. VERIFIED = evidence retrieved from a real system this turn. UNVERIFIED = not checked. FAILED = checked and the check failed. Never write VERIFIED without the supporting evidence in the same reply.',
