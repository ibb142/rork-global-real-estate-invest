...
export const AGENTS: Record<AgentId, AgentDefinition> = {
  cto_orchestrator: {
    ...
    riskLimit: 'high',
    routingKeywords: ['route', 'orchestrate', 'plan', 'coordinate'],
  },
  backend_developer: {
    id: 'backend_developer',
    name: 'Backend Developer Agent',
    role: 'Designs and patches Hono/Node backend code, APIs, and serverless handlers.',
    allowedTools: ['code_read', 'code_patch_proposal', 'run_tests', 'lint'],
    memoryNamespace: 'agent:backend',
    riskLimit: 'medium',
    routingKeywords: ['backend', 'hono', 'api', 'route', 'server', 'endpoint', 'node'],
  },
  frontend_developer: {
