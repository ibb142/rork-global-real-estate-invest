...
export const AGENTS: Record<AgentId, AgentDefinition> = {
  cto_orchestrator: {
    ...
    role: 'Routes incoming tasks to specialist agents, coordinates handoffs, enforces risk policy.',
    allowedTools: ['route', 'plan', 'handoff', 'audit_read'],
  ...
  ceo_executive: {
    id: 'ceo_executive',
    name: 'CEO Agent',
    role: 'Sets cross-business priorities, turns owner goals into ranked initiatives, and reviews what other agents propose.',
    allowedTools: ['memory_read', 'memory_write', 'plan', 'priority_rank', 'review_proposal'],
  ...
  backend_developer: {
    ...
    role: 'Analyzes code, detects bugs, proposes fixes, and drafts pull requests and tests across the Hono/Node backend.',
  ...
  frontend_developer: {
    ...
    role: 'Designs and patches Expo/React Native and web UI code.',
    allowedTools: ['code_read', 'code_patch_proposal', 'lint', 'screenshot_review'],
  ...
  infrastructure_sre: {
    ...
    role: 'Owns Render, AWS, DNS, deploys, rollbacks, runtime health.',
    allowedTools: ['render_status', 'aws_identity_check', 'deploy_gate_eval', 'rollback_propose'],
  ...
  supabase_database: {
    ...
    role: 'Owns Supabase schema, RLS, migrations, pgvector memory.',
    allowedTools: ['supabase_inspect', 'supabase_readiness_check', 'sql_proposal'],
  ...
  investor_relations: {
    ...
    role: 'Manages investor workflows, reports, and outreach drafts.',
    allowedTools: ['memory_read', 'draft_report', 'workflow_status'],
  ...
  analytics: {
    ...
    role: 'Aggregates telemetry, KPIs, and product metrics.',
    allowedTools: ['telemetry_query', 'memory_read'],
  ...
  operations: {
    ...
    role: 'Handles non-technical ops: incidents triage, owner comms, runbooks.',
    allowedTools: ['memory_read', 'incident_read', 'runbook_emit'],
  ...
  crm: {
    id: 'crm',
    name: 'CRM Agent',
    role: 'Keeps contacts and deals healthy, flags follow-ups, and drafts relationship updates.',
    allowedTools: ['memory_read', 'memory_write', 'crm_read', 'draft_update', 'workflow_status'],
  ...
  investment: {
    ...
    role: 'Watches the portfolio and market, surfacing opportunities and risks for the owner to act on.',
    allowedTools: ['memory_read', 'memory_write', 'portfolio_read', 'market_read', 'opportunity_rank'],
