...
const ARCH_SECTIONS: ArchSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        note: 'IPX Earn savings product. 4 profit tiers (10–15% APY). Daily interest accrual. Stored in AsyncStorage (@ipx_earn_data). Hook: useEarn().',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { label: '/(tabs)/invest', value: 'INVEST TAB — IPX properties, submit property, land partners' },
      ...
      { label: '/ipx-earn', value: 'IPX EARN — savings product: deposit funds, earn 10–15% APY' },
...
const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { icon: <BarChart3 size={16} color={Colors.success} />, text: 'Switch between Holdings (property shares), IPX (token investments), and Activity tabs.' },
  ...
  {
    id: 'invest-ipx',
    title: 'IPX Investment Platform',
    icon: <Landmark size={22} color={Colors.primary} />,
    color: Colors.primary,
    description: 'Exclusive IPX properties, property submissions, and land partnerships.',
    steps: [
      { icon: <Building2 size={16} color={Colors.primary} />, text: 'Invest tab shows curated IPX-exclusive properties with detailed metrics.' },
      ...
      { icon: <Sparkles size={16} color={Colors.primary} />, text: 'IPX tokens can be bought/sold, staked for rewards, and used for governance voting.' },
    ],
    proTip: 'Staking IPX tokens earns you higher dividend yields and early access to new listings.',
  },
  {
    id: 'wallet',
