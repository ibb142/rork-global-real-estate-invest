    ...
    <View style={styles.tabContent}>
      ...
      <View style={styles.quickActions}>
        ...
        <View style={styles.quickActionsGrid}>
          ...
          <TouchableOpacity style={styles.quickActionBtn}>
            <Heart size={22} color={Colors.negative} />
...
const styles = StyleSheet.create({
  ...
  bulkActionText: { color: Colors.textSecondary, fontSize: 13 },
  ...
  actionChipText: { color: Colors.textSecondary, fontSize: 13 },
  ...
  quickActionText: { color: Colors.textSecondary, fontSize: 13 },
  quickActionDesc: { color: Colors.textSecondary, fontSize: 13, lineHeight: 18 },
  ...
  generatedActionText: { color: Colors.textSecondary, fontSize: 13 },
  ...
  contentLinkActionText: { color: Colors.textSecondary, fontSize: 13 },
  ...
  shareQuickText: { color: Colors.textSecondary, fontSize: 13 },
  ...
  imageActionText: { color: Colors.textSecondary, fontSize: 13 },
