...
export default function EngagementScreen() {
  ...
  const [inactiveMembers, setInactiveMembers] = useState<MemberEngagementStats[]>(getInactiveMembers(2));
  const [activities, setActivities] = useState<MemberActivity[]>(getRecentActivities(10));
  const [stats] = useState(getEngagementStats());
  ...
  const renderInactiveMembers = () => (
    <View style={styles.listContainer}>
      <View style={styles.listHeader}>
        ...
        <TouchableOpacity style={styles.refreshButton} onPress={() => setInactiveMembers(getInactiveMembers(2))}>
    ...
    <View style={styles.listContainer}>
      <View style={styles.listHeader}>
        ...
        <View style={styles.messageBadge}>
          ...
          <Text style={styles.messageBadgeText}>{engagementMessages.length}</Text>
        </View>
      </View>
      {engagementMessages.map((msg) => (
...
const styles = StyleSheet.create({
  ...
  sendQueueText: { color: Colors.textSecondary, fontSize: 13 },
  ...
  sendMessageText: { color: Colors.textSecondary, fontSize: 13 },
  ...
  sendDraftText: { color: Colors.textSecondary, fontSize: 13 },
});
