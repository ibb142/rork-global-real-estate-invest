...
const styles = StyleSheet.create({
  ...
  stepNumberText: { color: Colors.textSecondary, fontSize: 13 },
  ...
  brokerCtaText: { color: Colors.textSecondary, fontSize: 13 },
  ...
  agentCtaText: { color: Colors.textSecondary, fontSize: 13 },
  ...
  influencerCtaText: { color: Colors.textSecondary, fontSize: 13 },
